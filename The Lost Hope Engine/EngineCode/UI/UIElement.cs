...
namespace TheLostHopeEngine.EngineCode.UI
{
    public abstract class UIElement
    {
        ...
        public UIElement(GraphicsDevice graphicsDevice, UIAnchor anchor, float xPosPercent, float yPosPercent, UIElement parent)
        {
        ...
        public Vector2 GetScreenPosition()
        {
            ...
            float maxX = Parent == null ? _graphicsDevice.Viewport.Width  : parentSize.X;
            float maxY = Parent == null ? _graphicsDevice.Viewport.Height : parentSize.Y;
